...
def upgrade():
    ...
    op.create_table(
        'index', sa.Column('digest_hash', sa.String(), nullable=False),
    ...
    op.create_index(op.f('ix_index_accessed_timestamp'),
                    'index', ['accessed_timestamp'],
                    unique=False)
    op.create_index(op.f('ix_index_digest_hash'),
                    'index', ['digest_hash'],
                    unique=False)
    op.create_table(
        'jobs', sa.Column('name', sa.String(), nullable=False),
    ...
    op.create_index(op.f('ix_jobs_action_digest'),
                    'jobs', ['action_digest'],
                    unique=False)
    op.create_index(op.f('ix_jobs_priority'),
                    'jobs', ['priority'],
                    unique=False)
    op.create_index(op.f('ix_jobs_stage'), 'jobs', ['stage'], unique=False)
    op.create_table(
        'leases', sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_leases_job_name'),
                    'leases', ['job_name'],
                    unique=False)
    op.create_index(op.f('ix_leases_worker_name'),
                    'leases', ['worker_name'],
                    unique=False)
    op.create_table(
        'operations', sa.Column('name', sa.String(), nullable=False),
        sa.Column('job_name', sa.String(), nullable=False),
        sa.Column('cancelled', sa.Boolean(), nullable=False),
        sa.ForeignKeyConstraint(['job_name'], ['jobs.name'],
                                onupdate='CASCADE',
                                ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('name'))
    op.create_index(op.f('ix_operations_job_name'),
                    'operations', ['job_name'],
                    unique=False)
